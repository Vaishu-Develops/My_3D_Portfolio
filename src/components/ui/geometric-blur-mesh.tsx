...
const GeometricBlurMesh: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-transparent cursor-pointer overflow-hidden">
            <canvas 
                ref={canvasRef}
...
export default GeometricBlurMesh;
