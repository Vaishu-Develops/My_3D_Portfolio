        ...
        */}
        <div className={`macbook-screen custom-animate-lid-screen w-[150px] h-[96px] absolute left-0 bottom-0 rounded-[7px] bg-[#ddd] 
          ...
          <div className={`macbook-screen-face-one w-[150px] h-[96px] absolute left-0 bottom-0 rounded-[7px] bg-[#d3d3d3]
            ...
            <div className="w-[130px] h-[74px] m-[10px] bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 bg-[length:200%_200%] animate-gradient rounded-[1px] relative shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] flex items-center justify-center">
              <div className="text-[10px] text-white/40 font-bold tracking-widest uppercase select-none">Vaishu Dev</div>
              <div className={`custom-animate-screen-shade absolute left-0 top-0 w-[130px] h-[74px] 
                              bg-[linear-gradient(-135deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.2)_47%,rgba(255,255,255,0)_48%)] 
